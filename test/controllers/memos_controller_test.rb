...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { account_id: @memo.account_id, body: @memo.body, title: @memo.title } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { account_id: @memo.account_id, body: @memo.body, title: @memo.title } }
